...
import type { BlindSpot, IdentifyBlindSpotsOutput, Severity } from '../types.js';
...
export function createIdentifyBlindSpotsHandler(db: DatabaseManager) {
  return async (rawInput: IdentifyBlindSpotsInput): Promise<IdentifyBlindSpotsOutput> => {
