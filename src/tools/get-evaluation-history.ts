...
import type { GetEvaluationHistoryOutput, AssessmentLevel } from '../types.js';
...
export function createGetEvaluationHistoryHandler(db: DatabaseManager) {
  return async (rawInput: GetEvaluationHistoryInput): Promise<GetEvaluationHistoryOutput> => {
