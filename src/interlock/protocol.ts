...
const SIGNAL_NAMES: Record<number, string> = {
  ...
  [SignalTypes.ASTROSENTRY_EVENT]: 'ASTROSENTRY_EVENT',
  [SignalTypes.COGNITIVE_INSIGHT]: 'COGNITIVE_INSIGHT',
  [SignalTypes.ETHICAL_CHECK_REQUEST]: 'ETHICAL_CHECK_REQUEST',
  [SignalTypes.ETHICAL_CHECK_RESPONSE]: 'ETHICAL_CHECK_RESPONSE',
  [SignalTypes.EXPERIENCE_QUERY]: 'EXPERIENCE_QUERY',
  [SignalTypes.EXPERIENCE_RESPONSE]: 'EXPERIENCE_RESPONSE',
};
